      ...
      <div>
        ...
        <div className='message'>
          <Container fluid className='message'>
            ...
            <Row>
              <Col sm={6}><span className='caption'>To whom: </span>Character / Character group name (character/character group Card ID)</Col>
            </Row>
            <Row>
            ...
            <Row>
              <Col sm={6}><span className='caption'>Sent: </span>Yes / No (editable dropdown)</Col>
            </Row>
            <Row>
              <Col sm>&nbsp;</Col>
            </Row>
